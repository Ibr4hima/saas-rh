...
export default function MyInformationsPage() {
  ...
  return (
    <Page>
      ...
      <div className="grid items-start gap-4 grid-cols-[minmax(0,1fr)] lg:grid-cols-[minmax(0,7fr)_minmax(0,5fr)]">
                ...
                <>
                  ...
                  {sent ? (
                    <p className="flex items-start gap-2 rounded-[12px] bg-success-soft px-3.5 py-2.5 text-[12.5px] text-success ring-1 ring-current/15 ring-inset">
                      ...
                      Signalement envoyé — la Direction du Capital Humain a été prévenue. Son état
                      se suit juste en dessous.
                    </p>
                  ) : null}
                        ...
                        <div className="min-w-0 flex-1 basis-56">
                          ...
                          <ul className="flex flex-col gap-1">
                            {r.fields.map((f) => (
                              <li
                                key={f.field}
                                className="text-[12.5px] leading-snug text-ink-muted"
                              >
